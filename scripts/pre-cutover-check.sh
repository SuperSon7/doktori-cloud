...
# --- 설정 ---
NGINX_PUBLIC_IP="${NGINX_PUBLIC_IP:?NGINX_PUBLIC_IP required}"
NGINX_INSTANCE="${NGINX_INSTANCE:?NGINX_INSTANCE required}"
API_INSTANCE="${API_INSTANCE:?API_INSTANCE required}"
AI_PRIVATE_IP="${AI_PRIVATE_IP:?AI_PRIVATE_IP required}"
API_PRIVATE_IP="${API_PRIVATE_IP:?API_PRIVATE_IP required}"
CHAT_PRIVATE_IP="${CHAT_PRIVATE_IP:?CHAT_PRIVATE_IP required}"
FRONT_PRIVATE_IP="${FRONT_PRIVATE_IP:?FRONT_PRIVATE_IP required}"
S3_BUCKET="doktori-prod"
DOMAIN="doktori.kr"
